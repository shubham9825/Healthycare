    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@healthcarelife.com">
                support@healthcarelife.com
              </a>
            </li>
            <li>
              <a href="mailto:appointment@healthcarelife.com">
                appointment@healthcarelife.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        <p>©2024 HealthCare Life. All rights reserved.</p>
